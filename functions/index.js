...
exports.addFollowing = functions.firestore
    ...
    .onCreate(async (snapshot, context) => {
        ...
        try {
            ...
            batch.update(await db.collection('users').doc(context.params.profileId), {
...
exports.removeFollowing = functions.firestore
    ...
    .onDelete(async (snapshot, context) => {
        ...
        batch
            .delete(db.collection('following')
                .doc(context.params.profileId)
                .collection('userFollowers')
                .doc(context.params.userUid))

        batch
            .update(db.collection('users')
                .doc(context.params.profileId), {
                followerCount: admin.firestore.FieldValue.increment(-1)
            })
        try {
